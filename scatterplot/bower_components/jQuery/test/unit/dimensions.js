...
QUnit.test( "setters with and without box-sizing:border-box", function( assert ) {
	...
	// Support: Firefox<29, android="" 2.3="" (prefixed="" box-sizing="" versions).="" var="" parent="jQuery(" "#foo"="" ).css(="" {="" width:="" "200px",="" height:="" "font-size":="" "16px"="" }="" ),="" el_bb="jQuery(" "<div="" style="margin:5px;padding:1px;border:2px solid black;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;"></29,></div>" ).appendTo( parent ),
