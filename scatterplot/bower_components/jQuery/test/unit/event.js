...
QUnit.test( "Delegated events in SVG (#10791; #13180)", function( assert ) {
	...
	var useElem, e,
		svg = jQuery(
			...
			"<defs><rect id="ref" x="10" y="20" width="100" height="60" r="10" rx="10" ry="10"/></defs>" +
			"<rect class="svg-by-class" x="10" y="20" width="100" height="60" r="10" rx="10" ry="10"/>" +
			"<rect id="svg-by-id" x="10" y="20" width="100" height="60" r="10" rx="10" ry="10"/>" +
			"<use id="use" xlink:href="#ref"/>" +
			"</svg>"
		);
	...
	// Fire a native click on an SVGElementInstance (the instance tree of an SVG <use></use>)
...
// Support: iOS 7+, Android<4.0 ios="" &="" old="" android="" have="" the="" window.onbeforeunload="" field="" but="" don't="" support="" beforeunload="" handler="" making="" it="" impossible="" to="" feature-detect="" support.="" if="" (="" null="" &&="" !="" (ipad|iphone|ipod|android="" 2\.3)="" i.test(="" navigator.useragent="" )="" {="" qunit.test(="" "on(beforeunload)",="" 1,="" function(="" assert="" var="" iframe="jQuery(" jquery.parsehtml(="" "<iframe="" src="data/event/onbeforeunload.html"><iframe>" ) );
...
QUnit.test( "Inline event result is returned (#13993)", function( assert ) {
	...
	var result = jQuery( "</p><p onclick="return 42">hello</p>" ).triggerHandler( "click" );
...
</xml:namespace></div></div></div></div></iframe></4.0></div></div></div></xml:namespace></a></a></div></div></div></div></div>