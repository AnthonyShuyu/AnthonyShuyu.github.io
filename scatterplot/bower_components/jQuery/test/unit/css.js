...
QUnit.test( "css(String|Hash)", function( assert ) {
	...
	div2 = jQuery( "<div style="display:none;"><input type="text" style="height:20px;"><textarea style="height:20px;"><div style="height:20px;"></div></textarea></div>" ).appendTo( "body" );
...
QUnit.test( "css() non-px relative values (gh-1711)", function( assert ) {
	...
	var cssCurrent,
		...
		add = function( prop, val, unit ) {
			...
			if ( difference <= 0="" 1="" 2="" 4="" 12="" 19="" 100="" 400="" )="" {="" assert.ok(="" true,="" message="" );="" ...or="" fail="" with="" actual="" and="" expected="" values="" }="" else="" false,="" +="" "="" (actual="" csscurrent="" ",="" ")"="" },="" getunits="function(" prop="" units[="" ]="{" "px":="" 1,="" "em":="" parsefloat(="" $child.css(="" prop,="" "100em"="" ).css(="" 100,="" "pt":="" "100pt"="" "pc":="" "100pc"="" "cm":="" "100cm"="" "mm":="" "100mm"="" "%":="" "100%"="" };="" jquery(="" "#nothiddendiv"="" height:="" padding:="" 0,="" width:="" getunits(="" "width"="" "width",="" "50%"="" add(="" 25,="" "%"="" -50,="" 10,="" "em"="" "pt"="" -2.3,="" 5,="" "pc"="" -5,="" +2,="" "cm"="" -15,="" "mm"="" 21,="" "px"="" "lineheight"="" "lineheight",="" "1em"="" 2,="" -10,="" 20,="" 30,="" -20,="" opera="" does="" something="" funky="" for="" this="" one="" just="" disabling="" 2.2="" 50,="" qunit.test(="" "css(string,="" object)",="" function(="" assert="" assert.expect(="" var="" j,="" div,="" display,="" ret,="" success;="" "#floattest"="" "float",="" "left"="" assert.equal(="" "float"="" ),="" "left",="" "modified="" css="" float="" using="" \"float\":="" is="" left"="" "font-size",="" "20px"="" "font-size"="" "20px",="" font-size:="" font-size="" 20px"="" jquery.each(="" "0,0.25,0.5,0.75,1".split(="" ","="" i,="" n="" "#foo"="" "opacity",="" "opacity"="" "assert="" opacity="" as="" a="" string"="" number"="" ""="" "1",="" when="" set="" to="" an="" empty="" contents="" will="" get="" comments="" regular,="" text,="" comment="" nodes="" j="jQuery(" "#nonnodes"="" ).contents();="" j.css(="" "overflow",="" "visible"="" "overflow"="" "visible",="" "check="" node,textnode,comment="" works"="" sometimes="" doesn't="" update="" 'display'="" correctly,="" see="" #2037="" "#t2037"="" )[="" ].innerhtml="jQuery(" ].innerhtml;="" "#t2037="" .hidden"="" "display"="" "none",="" "make="" sure="" browser="" thinks="" it="" hidden"="" div="jQuery(" display="div.css(" ret="div.css(" "display",="" undefined="" setting="" returns="" the="" original="" set."="" div.css(="" that="" wasn't="" changed."="" success="true;" try="" "backgroundcolor",="" "rgba(0,="" 0.1)"="" catch="" (="" e="" success,="" "setting="" rgba="" not="" throw="" error="" (#5509)"="" "font",="" "7px="" 21px="" sans-serif"="" assert.strictequal(="" "line-height"="" "21px",="" "set="" font="" shorthand="" property="" (#14759)"="" object)="" negative="" values",="" "margin-top",="" "-10px"="" "margin-left",="" "margin-top"="" "-10px",="" "ensure="" top="" margins="" work."="" "margin-left"="" left="" "position",="" "absolute"="" "top",="" "-20px"="" "top"="" "-20px",="" "css(array)",="" expectedmany="{" "overflow":="" "width":="" "16px"="" expectedsingle="{" elem="jQuery(" "<div=""></=></div>" ).appendTo( "#qunit-fixture" );
...
QUnit.test( "can't get css for disconnected in IE<9, 2="" see="" #10254="" and="" #8388",="" function(="" assert="" )="" {="" assert.expect(="" );="" var="" span,="" div;="" span="jQuery(" "<span="">" ).css( "background-image", "url(data/1x1.jpg)" );
	assert.notEqual( span.css( "background-image" ), null, "can't get background-image in IE<9, see="" #10254"="" );="" div="jQuery(" "<div="">" ).css( "top", 10 );
	assert.equal( div.css( "top" ), "10px", "can't get top in IE<9, 1="" see="" #8388"="" );="" }="" qunit.test(="" "ensure="" styles="" are="" retrieving="" from="" parsed="" html="" on="" document="" fragments",="" function(="" assert="" )="" {="" assert.expect(="" var="" $span="jQuery(" jquery.parsehtml(="" "<span="" style="\"font-family:" cuprum,sans-serif;="" font-size:="" 14px;="" color:="" #999999;\"="">some text</9,></9,></9,></p></div></div></div></div></span>" )
	);

	assert.equal( $span.css( "font-size" ), "14px", "Font-size retrievable on parsed HTML node" );
} );

QUnit.test( "can't get background-position in IE<9, see="" #10796",="" function(="" assert="" )="" {="" var="" div="jQuery(" "<div="">" ).appendTo( "#qunit-fixture" ),
		units = [
			"0 0",
			"12px 12px",
			"13px 12em",
	...
	for ( ; i < l; i++ ) {
		...
		assert.ok( div.css( "background-position" ), "can't get background-position in IE<9, 2="" see="" #10796"="" );="" }="" if="" (="" jquery.fn.offset="" )="" {="" qunit.test(="" "percentage="" properties="" for="" left="" and="" top="" should="" be="" transformed="" to="" pixels,="" #9505",="" function(="" assert="" assert.expect(="" var="" parent="jQuery(" "<div="" style="position:relative;width:200px;height:200px;margin:0;padding:0;border-width:0"></9,></9,></tr></div>" ).appendTo( "#qunit-fixture" ),
...
QUnit.test( "css('width') and css('height') should respect box-sizing, see #11004", function( assert ) {
	...
	// Support: Firefox<29, android="" 2.3="" (prefixed="" box-sizing="" versions).="" var="" el_dis="jQuery("<div" style="width:300px;height:300px;margin:2px;padding:2px;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;">test</29,></div>"),
...
</div></div></div></div></div></div></span></span></span></div></div></div></div></div>