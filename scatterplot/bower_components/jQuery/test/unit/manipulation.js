...
QUnit.test( "text(undefined)", function( assert ) {
	...
	assert.equal( jQuery( "#foo" ).text( "<div" 0="" 6="" ).text(="" undefined="" )[="" ].innerhtml,="" "&lt;div",="" ".text(undefined)="" is="" chainable="" (#5571)"="" );="" }="" function="" testtext(="" valueobj,="" assert="" )="" {="" assert.expect(="" var="" val,="" j,="" expected,="" $multipleelements,="" $parentdiv,="" $childdiv;="" val="valueObj(" "<div=""><b>Hello</b> cruel world!" );
...
QUnit.test( "html() object element #10324", function( assert ) {
	...
	var object = jQuery( "<object id="object2"><param name="object2test" value="test"></object>?" ).appendTo( "#qunit-fixture" ),
		clone = object.clone();
...
QUnit.test( "clone()", function( assert ) {
	...
	div = jQuery( "<div>" ).html( "<embed height="355" width="425" src="http://www.youtube.com/v/3KANI2dpXLw&amp;hl=en">" );
...
function testHtml( valueObj, assert ) {
	...
	assert.ok( /^[^<]*[^<\s][^<]*$ 4="" .test(="" fixture.html()="" ),="" "replace="" html="" with="" text"="" );="" }="" qunit.test(="" "html(string|number)",="" function(="" assert="" )="" {="" testhtml(="" manipulationbareobj,="" "html(function)",="" manipulationfunctionreturningobj,="" "html(function)="" incoming="" value="" --="" direct="" selection",="" assert.expect(="" var="" els,="" actualhtml,="" pass;="" els="jQuery(" "#foo=""> p" );
...
</script></div></div></div></p></div></bdi></div></div></div></div></div></div></b></code></div></section></div></div></div></\></\></i></b></div></div></]*[^<\s][^<]*$></select></map></div></div></\></scr.pt\s+type=['"]?text\></div></div></object></div></div></object></div></"></element></p></i></b></a></div></div></element></div></div></div></div></div></element></div></element></element></element></span></span></span></span></div></div></div></jquery></element></jquery></element></jquery></element></element></jquery></element></div></div></div></element></element></element></div></div></div></div></div></"></"></map></fieldset></div></div></div">